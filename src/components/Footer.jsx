...
const Footer = () => {
  return (    
    <div className="w-screen mt-20">
        <footer className="p-4 bg-gradient-to-r bg-zinc-900 px-8 lg:px-40">
            <div className="md:flex md:justify-between">
                <div className="mb-6 md:mb-0">
                    ...
                    <img 
                        ...
                        alt="logo"
                    />
                        <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-400 dark:text-white">Statmania</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-sm">
                    <div>
                        ...
                        <ul className="text-gray-300">
                            <li className="mb-4">
                                <a href="https://railway.app/" className="hover:underline">Railway</a>
                            </li>
                            <li>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">Prismly Blogs</a>. All Rights Reserved.
                </span>
