        ...
        <nav className="bg-blue-700 dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-500 dark:border-gray-600">
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button 
                    ...
                    type="button" 
                    className="text-gray-400 bg-zinc-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
